...
it("Encodes the received string using a key", ()=>{
  expect(caesarCipher("if he had anything confidential to say, he wrote it in cipher.",7)).toMatch("pm ol ohk hufaopun jvumpkluaphs av zhf, ol dyval pa pu jpwoly.")
});
